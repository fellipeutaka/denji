...
- [Oxlint Integration](/docs/preact/integrations/oxlint) - Pair with Oxlint for complete Oxc toolchain
- [Biome Integration](/docs/preact/integrations/biome) - Alternative all-in-one tool
- [Prettier Integration](/docs/preact/integrations/prettier) - Oxfmt aims for Prettier compatibility
- [Hooks](/docs/preact/configuration) - Learn about Denji hooks
