...
<Callout type="info">
While Oxlint fixes many issues, you may still want to combine it with a formatter like [Oxfmt](/docs/preact/integrations/oxfmt) or [Biome](/docs/preact/integrations/biome) for consistent code style.
</Callout>
...
- [Oxfmt Integration](/docs/preact/integrations/oxfmt) - Oxc formatter
- [Biome Integration](/docs/preact/integrations/biome) - Alternative all-in-one tool
- [ESLint Integration](/docs/preact/integrations/eslint) - Alternative with mature ecosystem
- [Configuration](/docs/preact/configuration) - Denji configuration options
