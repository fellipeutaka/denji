...
- [Ultracite Integration](/docs/preact/integrations/ultracite) - Zero-config Biome preset
- [ESLint Integration](/docs/preact/integrations/eslint) - Alternative linter
- [Prettier Integration](/docs/preact/integrations/prettier) - Alternative formatter
