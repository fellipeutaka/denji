...
<Cards>
  <Card title="ESLint" href="/docs/preact/integrations/eslint" description="Pluggable JavaScript linter" />
  <Card title="Prettier" href="/docs/preact/integrations/prettier" description="Opinionated code formatter" />
  <Card title="Biome" href="/docs/preact/integrations/biome" description="Fast all-in-one toolchain" />
  <Card title="Ultracite" href="/docs/preact/integrations/ultracite" description="Zero-config Biome preset" />
  <Card title="Oxlint" href="/docs/preact/integrations/oxlint" description="High-performance Rust linter" />
  <Card title="Oxfmt" href="/docs/preact/integrations/oxfmt" description="Oxc project formatter" />
</Cards>
