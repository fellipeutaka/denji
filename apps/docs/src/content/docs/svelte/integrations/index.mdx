...
<Cards>
  <Card title="ESLint" href="/docs/svelte/integrations/eslint" description="Pluggable JavaScript linter" />
  <Card title="Prettier" href="/docs/svelte/integrations/prettier" description="Opinionated code formatter" />
  <Card title="Biome" href="/docs/svelte/integrations/biome" description="Fast all-in-one toolchain" />
  <Card title="Ultracite" href="/docs/svelte/integrations/ultracite" description="Zero-config Biome preset" />
  <Card title="Oxlint" href="/docs/svelte/integrations/oxlint" description="High-performance Rust linter" />
  <Card title="Oxfmt" href="/docs/svelte/integrations/oxfmt" description="Oxc project formatter" />
</Cards>
