...
<Callout type="info">
While Oxlint fixes many issues, you may still want to combine it with a formatter like [Oxfmt](/docs/svelte/integrations/oxfmt) or [Biome](/docs/svelte/integrations/biome) for consistent code style.
</Callout>
...
- [Oxfmt Integration](/docs/svelte/integrations/oxfmt) - Oxc formatter
- [Biome Integration](/docs/svelte/integrations/biome) - Alternative all-in-one tool
- [ESLint Integration](/docs/svelte/integrations/eslint) - Alternative with mature ecosystem
- [Configuration](/docs/svelte/configuration) - Denji configuration options
