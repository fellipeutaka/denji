...
- [Oxlint Integration](/docs/svelte/integrations/oxlint) - Pair with Oxlint for complete Oxc toolchain
- [Biome Integration](/docs/svelte/integrations/biome) - Alternative all-in-one tool
- [Prettier Integration](/docs/svelte/integrations/prettier) - Oxfmt aims for Prettier compatibility
- [Hooks](/docs/svelte/configuration) - Learn about Denji hooks
