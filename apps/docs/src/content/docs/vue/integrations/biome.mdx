...
- [Ultracite Integration](/docs/vue/integrations/ultracite) - Zero-config Biome preset
- [ESLint Integration](/docs/vue/integrations/eslint) - Alternative linter
- [Prettier Integration](/docs/vue/integrations/prettier) - Alternative formatter
