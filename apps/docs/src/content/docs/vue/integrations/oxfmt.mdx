...
- [Oxlint Integration](/docs/vue/integrations/oxlint) - Pair with Oxlint for complete Oxc toolchain
- [Biome Integration](/docs/vue/integrations/biome) - Alternative all-in-one tool
- [Prettier Integration](/docs/vue/integrations/prettier) - Oxfmt aims for Prettier compatibility
- [Hooks](/docs/vue/configuration) - Learn about Denji hooks
