...
- [Biome Integration](/docs/vue/integrations/biome) - One of Ultracite's supported toolchains
- [ESLint Integration](/docs/vue/integrations/eslint) - One of Ultracite's supported toolchains
- [Prettier Integration](/docs/vue/integrations/prettier) - Part of ESLint toolchain option
- [Oxlint Integration](/docs/vue/integrations/oxlint) - One of Ultracite's supported toolchains
- [Oxfmt Integration](/docs/vue/integrations/oxfmt) - Part of Oxlint toolchain option
