...
<Callout type="info">
While Oxlint fixes many issues, you may still want to combine it with a formatter like [Oxfmt](/docs/vue/integrations/oxfmt) or [Biome](/docs/vue/integrations/biome) for consistent code style.
</Callout>
...
- [Oxfmt Integration](/docs/vue/integrations/oxfmt) - Oxc formatter
- [Biome Integration](/docs/vue/integrations/biome) - Alternative all-in-one tool
- [ESLint Integration](/docs/vue/integrations/eslint) - Alternative with mature ecosystem
- [Configuration](/docs/vue/configuration) - Denji configuration options
