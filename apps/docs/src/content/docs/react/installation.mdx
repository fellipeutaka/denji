---
title: Installation
description: Install and set up Denji in your React project
---
...
<Cards>
  <Card title="Configuration" href="/docs/react/configuration" description="Configure Denji options" />
  <Card title="Add Icons" href="/docs/react/commands/add" description="Start adding icons" />
</Cards>
