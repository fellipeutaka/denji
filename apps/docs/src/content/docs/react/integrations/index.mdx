...
<Cards>
  <Card title="ESLint" href="/docs/react/integrations/eslint" description="Pluggable JavaScript linter" />
  <Card title="Prettier" href="/docs/react/integrations/prettier" description="Opinionated code formatter" />
  <Card title="Biome" href="/docs/react/integrations/biome" description="Fast all-in-one toolchain" />
  <Card title="Ultracite" href="/docs/react/integrations/ultracite" description="Zero-config Biome preset" />
  <Card title="Oxlint" href="/docs/react/integrations/oxlint" description="High-performance Rust linter" />
  <Card title="Oxfmt" href="/docs/react/integrations/oxfmt" description="Oxc project formatter" />
</Cards>
