...
<Callout type="info">
While Oxlint fixes many issues, you may still want to combine it with a formatter like [Oxfmt](/docs/react/integrations/oxfmt) or [Biome](/docs/react/integrations/biome) for consistent code style.
</Callout>
...
- [Oxfmt Integration](/docs/react/integrations/oxfmt) - Oxc formatter
- [Biome Integration](/docs/react/integrations/biome) - Alternative all-in-one tool
- [ESLint Integration](/docs/react/integrations/eslint) - Alternative with mature ecosystem
- [Configuration](/docs/react/configuration) - Denji configuration options
