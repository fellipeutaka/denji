...
- [Oxlint Integration](/docs/react/integrations/oxlint) - Pair with Oxlint for complete Oxc toolchain
- [Biome Integration](/docs/react/integrations/biome) - Alternative all-in-one tool
- [Prettier Integration](/docs/react/integrations/prettier) - Oxfmt aims for Prettier compatibility
- [Hooks](/docs/react/configuration) - Learn about Denji hooks
