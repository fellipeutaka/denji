...
- [Biome Integration](/docs/solid/integrations/biome) - One of Ultracite's supported toolchains
- [ESLint Integration](/docs/solid/integrations/eslint) - One of Ultracite's supported toolchains
- [Prettier Integration](/docs/solid/integrations/prettier) - Part of ESLint toolchain option
- [Oxlint Integration](/docs/solid/integrations/oxlint) - One of Ultracite's supported toolchains
- [Oxfmt Integration](/docs/solid/integrations/oxfmt) - Part of Oxlint toolchain option
