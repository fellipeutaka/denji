...
<Callout type="info">
While Oxlint fixes many issues, you may still want to combine it with a formatter like [Oxfmt](/docs/solid/integrations/oxfmt) or [Biome](/docs/solid/integrations/biome) for consistent code style.
</Callout>
...
- [Oxfmt Integration](/docs/solid/integrations/oxfmt) - Oxc formatter
- [Biome Integration](/docs/solid/integrations/biome) - Alternative all-in-one tool
- [ESLint Integration](/docs/solid/integrations/eslint) - Alternative with mature ecosystem
- [Configuration](/docs/solid/configuration) - Denji configuration options
