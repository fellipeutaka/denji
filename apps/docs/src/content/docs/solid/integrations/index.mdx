...
<Cards>
  <Card title="ESLint" href="/docs/solid/integrations/eslint" description="Pluggable JavaScript linter" />
  <Card title="Prettier" href="/docs/solid/integrations/prettier" description="Opinionated code formatter" />
  <Card title="Biome" href="/docs/solid/integrations/biome" description="Fast all-in-one toolchain" />
  <Card title="Ultracite" href="/docs/solid/integrations/ultracite" description="Zero-config Biome preset" />
  <Card title="Oxlint" href="/docs/solid/integrations/oxlint" description="High-performance Rust linter" />
  <Card title="Oxfmt" href="/docs/solid/integrations/oxfmt" description="Oxc project formatter" />
</Cards>
