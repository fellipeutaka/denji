...
- [Oxlint Integration](/docs/solid/integrations/oxlint) - Pair with Oxlint for complete Oxc toolchain
- [Biome Integration](/docs/solid/integrations/biome) - Alternative all-in-one tool
- [Prettier Integration](/docs/solid/integrations/prettier) - Oxfmt aims for Prettier compatibility
- [Hooks](/docs/solid/configuration) - Learn about Denji hooks
