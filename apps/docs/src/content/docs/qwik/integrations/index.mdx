...
<Cards>
  <Card title="ESLint" href="/docs/qwik/integrations/eslint" description="Pluggable JavaScript linter" />
  <Card title="Prettier" href="/docs/qwik/integrations/prettier" description="Opinionated code formatter" />
  <Card title="Biome" href="/docs/qwik/integrations/biome" description="Fast all-in-one toolchain" />
  <Card title="Ultracite" href="/docs/qwik/integrations/ultracite" description="Zero-config Biome preset" />
  <Card title="Oxlint" href="/docs/qwik/integrations/oxlint" description="High-performance Rust linter" />
  <Card title="Oxfmt" href="/docs/qwik/integrations/oxfmt" description="Oxc project formatter" />
</Cards>
