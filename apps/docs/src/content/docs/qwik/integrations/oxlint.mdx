...
<Callout type="info">
While Oxlint fixes many issues, you may still want to combine it with a formatter like [Oxfmt](/docs/qwik/integrations/oxfmt) or [Biome](/docs/qwik/integrations/biome) for consistent code style.
</Callout>
...
- [Oxfmt Integration](/docs/qwik/integrations/oxfmt) - Oxc formatter
- [Biome Integration](/docs/qwik/integrations/biome) - Alternative all-in-one tool
- [ESLint Integration](/docs/qwik/integrations/eslint) - Alternative with mature ecosystem
- [Configuration](/docs/qwik/configuration) - Denji configuration options
