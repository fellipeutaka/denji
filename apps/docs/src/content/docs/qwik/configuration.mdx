---
title: Configuration
description: Configure Denji options and hooks for Qwik
---
...
<Callout type="info">
Qwik doesn't use `forwardRef` - refs are passed as regular props. Denji handles this automatically. In folder mode, icons are wrapped with `component$()` for full Qwik compatibility.
</Callout>
